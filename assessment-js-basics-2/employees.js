...
//CODE HERE  !!!!!!ask for help for review!!!
class Employee {
    ...
    getSchedule(){
        console.log('I am', this.name, 'from', this.shifts);
      }
...
const {Nick} = empTwo // ask if this is right? it returns undefined when console.log 
